...
<div id="login_place">
    ...
    <?php else: ?>
        ...
        <?php echo form_close(); ?>
        <br/>
        <a href="<?php echo base_url() ?>listaPublica">Não recebi um código para autenticar/emitir meu certificado</a>
        <br/>
        <a href="<?php echo base_url() ?>">Clique aqui para voltar à tela de entrada</a>
    <?php endif; ?>
    <?php echo @$retorno; ?>
</div>
<div class="clear"></div>
