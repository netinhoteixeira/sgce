...
<div class="center_table">
    <div class="form_left">
        <p align="left">
            ...
            <input name="txtId" class="disabled_input" value="<?php echo @$evento->id_evento ?>"
                   type="text" id="txtId" size="10" readonly="readonly"/>
            <br/><br/>

            <label for='txtNome'>Nome*: </label>
            <input name="txtNome" type="text" value="<?php echo @$evento->nm_evento ?>" id="txtNome" size="50"/>
            <br/><br/>

            <label for='txtSigla'>Sigla*: </label>
            <input name="txtSigla" type="text" value="<?php echo @$evento->sg_evento ?>" id="txtSigla" size="50"/>
            <br/><br/>

            <label for='txtPeriodo'>Período de Realização*: </label>
            <input name="txtPeriodo" type="text" value="<?php echo @$evento->de_periodo ?>" id="txtPeriodo" size="50"/>
            <br/><br/>

            <label for='txtCarga'>Carga Horária*: </label>
            <input name="txtCarga" type="text" value="<?php echo @$evento->de_carga ?>" id="txtCarga" size="50"/>
            <br/><br/>

            <label for='txtLocal'>Local de Realização*: </label>
            <input name="txtLocal" type="text" value="<?php echo @$evento->de_local ?>" id="txtLocal" size="50"/>
            <br/><br/>

            <label for='txtURL'>Site do Evento: </label>
            <input name="txtURL" type="text" value="<?php echo @$evento->de_url ?>" id="txtURL" size="50"/>
            <br/><br/>

            <label for='txtEmail'>E-mail do Evento*: </label>
            <input name="txtEmail" type="text" value="<?php echo @$evento->de_email ?>" id="txtEmail" size="50"/>
            <br/><br/>

            <label for='txtDtInclusao'>Data de Inclusão: </label>
            <input name="txtDtInclusao" class="disabled_input" type="text"
                   value="<?php echo dataBR(@$evento->dt_inclusao) ?>" id="txtDtInclusao" size="10"
                   readonly="readonly"/>
            <br/><br/>

            <label for='txtDtAlteracao'>Data de Alteração: </label>
            <input name="txtDtAlteracao" class="disabled_input" type="text"
                   value="<?php echo dataBR(@$evento->dt_alteracao) ?>" id="txtDtAlteracao" size="10"
                   readonly="readonly"/>
            <br/><br/>
