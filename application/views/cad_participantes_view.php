...
<?php echo form_open_multipart(base_url() . 'participantes/salvar'); ?>
    <div class="botoes_left">
        ...
        <button onclick="parent.location='<?php echo base_url() ?>participantes/cancelar'" type="button"
                id="botao_cancelar">
    ...
    <div class="center_table">
        <div class="form_left">
            <p>
                ...
                <input name="txtId" class="disabled_input" value="<?php echo @$participante->id_participante ?>"
                       type="text" id="txtId" size="10" readonly="readonly"/>
                <br/><br/>

                <label for='txtNome'>Nome*: </label>
                <input name="txtNome" type="text" value="<?php echo @$participante->nm_participante ?>" id="txtNome"
                       size="50"/>
                <br/><br/>

                <label for='txtNrDocumento'>Documento: </label>
                <input name="txtNrDocumento" type="text" value="<?php echo @$participante->nr_documento ?>"
                       id="txtNrDocumento" size="50" maxlength="20"/>
                <br/><br/>

                <label for='txtDeEmail'>E-mail*: </label>
                <input name="txtDeEmail" type="text" value="<?php echo @$participante->de_email ?>" id="txtDeEmail"
                       size="50"/>
                <br/><br/>

                <label for='txtDtInclusao'>Data de Inclusão: </label>
                <input name="txtDtInclusao" class="disabled_input" type="text"
                       value="<?php echo dataBR(@$participante->dt_inclusao) ?>" id="txtDtInclusao" size="10"
                       readonly="readonly"/>
                <br/><br/>

                <label for='txtDtAlteracao'>Data de Alteração: </label>
                <input name="txtDtAlteracao" class="disabled_input" type="text"
                       value="<?php echo dataBR(@$participante->dt_alteracao) ?>" id="txtDtAlteracao" size="10"
                       readonly="readonly"/>
                <br/><br/>
            </p>
