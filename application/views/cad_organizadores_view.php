        ...
        <div class="form_left">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input name="txtId" class="disabled_input" value="<?php echo @$organizador->id_organizador ?>"
                           type="text" id="txtId" size="10" readonly="readonly"/>
                    <br/><br/>

                    <label for='txtNome'>Nome*: </label>
                    <input name="txtNome" type="text" value="<?php echo @$organizador->nm_organizador ?>"
                           id="txtNome" size="50"/>
                    <br/><br/>

                    <label for='txtDocumento'>Documento*: </label>
                    <input name="txtDocumento" type="text" value="<?php echo @$organizador->nr_documento ?>"
                    ...
                    <input name="txtEmail" type="text"
                           value="<?php echo @$organizador->de_email ?>"
                           id="txtEmail" size="50"/>
                    <br/><br/>

                    <label for='txtTelefone'>Telefone*: </label>
                    <input name="txtTelefone" type="text"
                           value="<?php echo @$organizador->nr_telefone ?>"
                    ...
                    <input name="txtDtInclusao" class="disabled_input"
                           type="text" value="<?php echo dataBR(@$organizador->dt_inclusao) ?>"
                    ...
                    <input name="txtDtAlteracao" class="disabled_input"
                           type="text" value="<?php echo dataBR(@$organizador->dt_alteracao) ?>"
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input name="txtUsuario" type="text"
                           value="<?php echo @$organizador->de_usuario ?>"
                    ...
                    <? if ($this->session->userdata('admin') == '1'): ?>
                        ...
                        <select name='txtFlAdmin' id='txtFlAdmin'>
                            ...
                            <option value='N' <?php echo (@$organizador->fl_admin == 'N') ? 'selected' : ''; ?> >Não
                            </option>
                            <option value='L' <?php echo (@$organizador->fl_admin == 'L') ? 'selected' : ''; ?> >
                                Limitado
                            </option>
                        </select>
                        <br/><br/>
                        ...
                        <select name='txtFlControlador' id='txtFlControlador'>
                            <option value='S' <?php echo (@$organizador->fl_controlador == 'S') ? 'selected' : ''; ?> >
                                Sim
                            </option>
                            <option value='N' <?php echo (@$organizador->fl_controlador == 'N') ? 'selected' : ''; ?> >
                                Não
                            </option>
                        </select>
                        <br/><br/>
