...
<table width="100%" border='0' class="center_table" id="data_table">
    <tr class="linha_par">
        <td width="80px"><b><a href="<?php echo base_url() . 'participantes/ordenar/codigo' ?>">C&oacute;digo</a></b>
        </td>
        <td><b><a href="<?php echo base_url() . 'participantes/ordenar/nome' ?>">Nome</a></b></td>
        <td><b><a href="<?php echo base_url() . 'participantes/ordenar/evento' ?>">Evento</a></b></td>
