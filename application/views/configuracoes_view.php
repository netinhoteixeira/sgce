...
?>
    ...
    <script type="text/javascript"
            src='<?php echo base_url() ?>application/views/includes/js/eventos.js'></script>
...
<?php echo form_open(base_url() . 'configuracoes/salvar'); ?>
    <div class="botoes_left">
        ...
        <button onclick="confirmaRestauracaoConfig('<?php echo base_url() ?>configuracoes/restaurar');"
                type="button" id="botao_restaurar" title="Restaurar a configuração padrão">
            <img src='<?php echo base_url() ?>application/views/includes/images/restaurar_32.png'
                 alt="Cancelar"/><br>Restaur.
        </button>

        <button onclick="parent.location='<?php echo base_url() ?>configuracoes/cancelar'"
