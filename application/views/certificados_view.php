...
<div id="searchRegister" class="center_table">
    <div id="pesq_message" class="form_left">
        <?php echo form_open('certificados/listar'); ?>
        <p>Pesquisar por:</p>
...
<table width="100%" border='0' class="center_table" id="data_table">
    <tr class="linha_par">
        <td width="80px"><b><a href="<?php echo base_url() . 'certificados/ordenar/codigo' ?>">C&oacute;digo</a></b>
        </td>
        <td><b><a href="<?php echo base_url() . 'certificados/ordenar/nome' ?>">Certificado</a></b></td>
        <td><b><a href="<?php echo base_url() . 'certificados/ordenar/nome_participante' ?>">Pessoa</a></b></td>
        <td><b><a href="<?php echo base_url() . 'certificados/ordenar/validacao' ?>">Cód. Validação</a></b>
        <td width="50px"><b><a href="<?php echo base_url() . 'certificados/ordenar/situacao' ?>">Situação</a></b></td>
