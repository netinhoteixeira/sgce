...
?>
        ...
        <div class="col-sm-12">
            <div class="pull-right">
                <button type="button" class="btn btn-light pull-right"
                        onclick="parent.location='<?php echo base_url(); ?>eventos/novo'"><i class="fas fa-plus"></i>
                    Adicionar
                </button>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?php echo form_open('eventos/listar'); ?>
        ...
        <div class="col-sm-12">
            <?php if (!isset($mensagem)) { ?>
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                    <tr>
                        <th><a href="<?php echo base_url('eventos/ordenar/codigo'); ?>">C&oacute;digo</a></th>
                        <th><a href="<?php echo base_url('eventos/ordenar/nome'); ?>">Nome</a></th>
                        <th></th>
                    </tr>
                    </thead>
                    <!--Table head-->
                    ...
                    <?php foreach ($eventos as $row) { ?>
                        <tr>
                            <th scope="row"><?php echo $row->id_evento; ?></th>
                            <td><?php echo $row->nm_evento; ?></td>
                            <td>
                                <div class="pull-right">
                                    <button type="button" class="btn btn-sm btn-primary"
                                            onclick="location.href='<?php echo base_url('eventos/editar/' . $row->id_evento); ?>'">
                                        <i class="fas fa-pencil-alt"></i> Editar
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger"
                                            onclick="confirmaExclusao('<?php echo base_url('eventos/excluir/' . $row->id_evento); ?>','de <?php echo $row->nm_evento; ?>')">
...
<?php
/* End of file eventos_view.php */
/* Location: ./application/views/eventos_view.php */