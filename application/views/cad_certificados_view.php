    ...
    <div class="center_table">
        <div class="form_left">
            <p>
                ...
                <input name="txtId" class="disabled_input" value="<?php echo @$certificado->id_certificado ?>"
                       type="text" id="txtId" size="10" readonly="readonly"/>
                <br/><br/>

                <label for='txtNome'>Evento*: </label>
                <input name="txtNome" type="text" class="disabled_input" value="<?php echo @$certificado->nm_evento ?>"
                       id="txtNome" size="50"/>
                <br/><br/>

                <label for='txtNome'>Emitido para*: </label>
                <input name="txtNome" type="text" class="disabled_input"
                       value="<?php echo @$certificado->nm_participante ?>"
                       id="txtNome" size="50"/>
                <br/><br/>

                <label for='txtNome'>Texto*: </label>
                <textarea class="ckeditor" name="txtTextoCertificado" id="txtTextoCertificado" rows="4"
                          cols="40"><?php echo @$certificado->de_texto_certificado ?></textarea>
                <br/><br/>

                <label for='txtHash'>Cód. Autenticação: </label>
                <input name="txtHash" class="disabled_input" type="text" value="<?php echo @$certificado->de_hash ?>"
                       id="txtHash" size="10" readonly="readonly"/>
                <br/><br/>

                <label for='txtDtInclusao'>Data de Inclusão: </label>
                <input name="txtDtInclusao" class="disabled_input" type="text"
                       value="<?php echo dataBR(@$certificado->dt_inclusao) ?>" id="txtDtInclusao" size="10"
                       readonly="readonly"/>
                <br/><br/>

                <label for='txtDtAlteracao'>Data de Alteração: </label>
                <input name="txtDtAlteracao" class="disabled_input" type="text"
                       value="<?php echo dataBR(@$certificado->dt_alteracao) ?>" id="txtDtAlteracao" size="10"
                       readonly="readonly"/>
                <br/><br/>
            </p>
