...
//                 WHERE  id_organizador = $idOrganizador ";
        ...
        $this->db->select('id_organizador');
        $this->db->where('id_organizador', $idOrganizador);
        $origem = $this->db->get('organizadores_evento');
        $dados = $origem->result();
    ...
    function listarOrganizadores()
    {
        ...
        $this->db->order_by('nm_organizador');
...
/* End of file organizadores_model.php */
/* Location: ./application/models/organizadores_model.php */